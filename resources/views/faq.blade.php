                ...
                <div class="accordion" id="faqAccordion">
                    <div class="card">
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                            ...
                            <div class="card-body">
                                DepressionTracker adalah sebuah situs yang membantu mahasiswa akhir mengukur tingkat depresi
                    ...
                    <div class="card">
                        <div class="card-header" id="headingTwo">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                    ...
                                    Siapa yang bisa mengakses DepressionTracker?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                DepressionTracker ditujukan untuk mahasiswa akhir, namun siapa saja dapat mengakses situs ini
                    ...
                    <div class="card">
                        <div class="card-header" id="headingThree">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                    ...
                                    Apakah hasil dari DepressionTracker dapat diandalkan?
                                </button>
                            </h2>
                        </div>
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                            data-parent="#faqAccordion">
                            <div class="card-body">
                                Hasil dari DepressionTracker adalah sebuah estimasi dari tingkat depresi seseorang, dan tidak
                        ...
                        <div class="card-header" id="headingFour">
                            <h2 class="mb-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                    ...
                                    Bagaimana cara mengakses solusi yang ditawarkan DepressionTracker?
                                </button>
                            </h2>
                        </div>
            ...
            <footer>
                <div class="footerContainer">
                    <div class="socialIcons">
                        <a href="https://www.facebook.com/viona.stmrng"><i class="fa-brands fa-facebook"></i></a>
                        <a href="https://www.instagram.com/vionastrng_/"><i class="fa-brands fa-instagram"></i></a>
                        <a href="https://twitter.com/wiseconnector/status/1679760183688306688"><i class="fa-brands fa-twitter"></i></a>
                        <a href="https://www.google.com/"><i class="fa-brands fa-google-plus"></i></a>
                        <a href="https://youtu.be/fWFuQR_Wt4M"><i class="fa-brands fa-youtube"></i></a>
                    </div>
                    <div class="footerNav">
                        <ul>
                            <li><a href="/">Home</a></li>
                            <li><a href="https://www.youtube.com/results?search_query=news+depression">News</a></li>
                ...
                <div class="footerBotton">
                    <p>Copyright &copy;2023 Designed by <span class="designer">Viona</span></p>
                </div>
            </footer>
        </section>
